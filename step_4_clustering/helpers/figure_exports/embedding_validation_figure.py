...
def main() -> None:
    """Rebuild the embedding validation figure."""
    ...
    axes[2].bar(x + metric_width / 2, df["nmi"], metric_width, label="NMI", color="#355C7D")
    ...
    fig.tight_layout()
    save_current_figure(FIG_DIR, "embedding_validation")
